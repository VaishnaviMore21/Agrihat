...
if(isset($_POST['register'])){
   ...
   $select_accounts = mysqli_query($conn, "SELECT * FROM `selleraccounts` WHERE fname = '$fname'");

   if(mysqli_num_rows($select_accounts) > 0){
      $message[] = 'you have already registered';
      
   }else{
      $insert_account = mysqli_query($conn, "INSERT INTO `selleraccounts`(fname, lname, email, passw) VALUES('$fname', '$lname', '$email', '$passw')");
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="first-name" class="form-control" name="fname" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="last-name" class="form-control" name="lname" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                                ...
                                <br><br>
                                <div class="text sign-up-text">have an account? <a href="sellerlogin.php">Login</a></div>
                            </div>
                    </div>
                    </form>
                </div>
